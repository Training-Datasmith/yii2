...
<head>
    ...
    <?php 
$this->render_view_file(__DIR__ . '/css.php');
?>
</head>
<body>
<div class="container">
...
foreach ($requirements as $requirement) {
    ?>
            <tr class="<?php 
    echo $requirement['condition'] ? 'success' : ($requirement['mandatory'] ? 'danger' : 'warning');
    ?>">
                <td>
                <?php 
    ...
    echo $requirement['condition'] ? 'Passed' : ($requirement['mandatory'] ? 'Failed' : 'Warning');
    ?></span>
                </td>
                <td>
                <?php 
...
?>
    ...
    <footer>
        <p>Server: <?php 
echo $this->get_server_info() . ' ' . $this->get_now_date();
?></p>
