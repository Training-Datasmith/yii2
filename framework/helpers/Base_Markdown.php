...
class Base_Markdown
{
     ...
     */
    public static $flavors = ['original' => ['class' => 'cebe\markdown\Markdown', 'html5' => true], 'gfm' => ['class' => 'cebe\markdown\GithubMarkdown', 'html5' => true], 'gfm-comment' => ['class' => 'cebe\markdown\GithubMarkdown', 'html5' => true, 'enableNewlines' => true], 'extra' => ['class' => 'cebe\markdown\MarkdownExtra', 'html5' => true]];
    /**
     * @var string the markdown flavor to use when none is specified explicitly.
     * Defaults to `original`.
     * @see flavors
     */
    public static $default_flavor = 'original';
    /**
    ...
    {
        $parser = static::get_parser($flavor);
     ...
     * @throws InvalidArgumentException when an undefined flavor is given.
     */
    public static function process_paragraph($markdown, $flavor = null)
    {
        $parser = static::get_parser($flavor);
        return $parser->parse_paragraph($markdown);
    }
    /**
     * @param string|null $flavor the markdown flavor to use. See [[$flavors]] for available values.
     * Defaults to [[$defaultFlavor]], if not set.
