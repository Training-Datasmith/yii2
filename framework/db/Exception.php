...
class Exception extends \yii\base\Exception
{
     ...
     */
    public function __construct($message, $error_info = [], $code = '', $previous = null)
    {
    ...
    {
        return parent::__toString() . PHP_EOL . 'Additional Information:' . PHP_EOL . print_r($this->error_info, true);
    }
}